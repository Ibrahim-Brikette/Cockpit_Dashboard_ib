 ...
 * Resource-level check — delegates to DataQueryPermissionEvaluator via the delegator.
 * #id is resolved from the annotated method's parameter named "id" at call time.
 */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@PreAuthorize("hasPermission(#id, 'Query', 'query:view')")
public @interface CanViewQuery {}
